 ...
 * @LastEditTime: 2024-08-07 10:29:42
 * @License: GPL 3.0
 */
...
void Twai_Send_Message()
{
    ...
    message.data[2] = 0x0A;
    message.data[3] = 0x0A;
    message.data[4] = (uint8_t)(CAN_Send_Data >> 24);
    message.data[5] = (uint8_t)(CAN_Send_Data >> 16);
    message.data[6] = (uint8_t)(CAN_Send_Data >> 8);
    message.data[7] = (uint8_t)CAN_Send_Data;
...
void Twai_Receive_Message(twai_message_t &message)
{
    ...
    if (!(message.rtr))
    {
        ...
        CAN_Send_Data = CAN_Receive_Data + 1;
    }
}
